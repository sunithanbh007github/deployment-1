...
"
minikube "start" "--cpus" "2" "--memory" "4g" "--driver" "docker" "--profile" "polar-1"
echo "
🔌 Enabling NGINX Ingress Controller...
"
minikube "addons" "enable" "ingress" "--profile" "polar-1"
sleep "15"
echo "
📦 Deploying Keycloak..."
...
kubectl "wait" "--for=condition=ready" "pod" "--selector=app=polar-keycloak-1" "--timeout=300s"
echo "
...
kubectl "wait" "--for=condition=ready" "pod" "--selector=db=polar-postgres-1" "--timeout=180s"
echo "
📦 Deploying Redis..."
...
kubectl "wait" "--for=condition=ready" "pod" "--selector=db=polar-redis-1" "--timeout=180s"
echo "
📦 Deploying RabbitMQ..."
...
kubectl "wait" "--for=condition=ready" "pod" "--selector=db=polar-rabbitmq-1" "--timeout=180s"
echo "
⛵ Happy Sailing!
"